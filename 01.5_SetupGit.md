...
If *Getting Started* page will not appear, just press <Ctrl + Shift + P> to open the command palette, enter "Git Clone" and hit enter
<br><img src="./images/clone_repo2.png" width="400"/><br>

Enter the URL that you grabbed from the "*clone*" button hit enter and choose a folder where do want to save
<br><img src="./images/clone_repo2_1.png" width="400"/><br>
